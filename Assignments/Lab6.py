...
ALGORITHM:
    ...
    3. get choice from user (encrypt, decrypt, or quit)
        3a. if invalid response, warn user 
    4. Continue based on choice
        4a. encryption
            4a.1. get phrase from user
            4a.2. get key from user
            4a.3. use the ord() function and string.ascii_uppercase to shift each letter the number of times as the given key 
            4a.4. output encrypted message
        4b. decryption
            4b.1. get phrase from user
            4b.2. get key from user
            4b.3. use the ord() function and string.ascii_uppercase to shift each letter backwards the number of times as the given key 
